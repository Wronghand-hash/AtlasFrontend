...
const uploadImage = async function (event) {
  ...
  await $fetch("https://auth.atlasacademy.ir/management/firstimage", {
    method: "POST",
    credentials: "include",
...
const uploadImage2 = async function (event) {
  ...
  await $fetch("https://auth.atlasacademy.ir/management/secondimage", {
    method: "POST",
    credentials: "include",
    withCredentials: true,
    body: formData,
...
const uploadImage3 = async function (event) {
  ...
  await $fetch("https://auth.atlasacademy.ir/management/thirdimage", {
    method: "POST",
    credentials: "include",
    withCredentials: true,
    body: formData,
