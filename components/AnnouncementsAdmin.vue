...
//     await $fetch(
//       `https://auth.atlasacademy.ir/announcements/management/bookimageremove/${props.announce.BooksImages[0].id}`,
//       {
//         method: "POST",
//         headers: {
...
const removeAnnouncement = async function () {
  await $fetch(
    `https://auth.atlasacademy.ir/announcements/management/bookremove/${props.announce.id}`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
