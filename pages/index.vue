<template>
  ...
  <div class="h-full w-screen bg-mainWhite overflow-hidden">
    ...
    >
      ...
      <div
        class="w-full h-full z-20 lg:absolute flex lg:flex-row flex-col items-center lg:items-end pb-14 justify-center lg:space-y-0 space-y-6 lg:space-x-10"
      >
        <div
    ...
    >
      ...
      >
        ...
        <h2 dir="rtl" class="text-right text-darkBlue leading-loose">
          بهترین های دنیا در اطلس یا ژاپن در اطلس منظومه آموزشی و فرهنگی اطلس
          شامل دو واحد زبان های خارجی دخترانه و پسرانه و همچنین دبستانه دخترانه
          غیر دولتی دخترانه میباشد و در هر زمنیه از فعالیت خود با بهره گیری از
          دانش روز ،امکانات و تجهیزات پیشرفته ، استاد و مربیان توانمند ، درفضایی
          بیش از هزار متر مربع خدمات آموزشی خود را ارائه می نماید موسسه آموزشی
          اطلس رسالت خود را در قالب موارد زیل هدف گذاری نمونه است:
        </h2>
...
const events = ref([
  {
    status: "بهره گیری از شیوه های آموزشی نوین بین المللی",
  },
  {
    status:
      "شناسایی و آموزش گمشده های تربیتی ، اخلاقی ، اجتماعی جامعه به دانش آموزان",
  },
  {
    status: "تلاش برای آموزش مهارت های زندگی و روش های کسب درآمد در سنین کم",
  },
  {
    status:
      "ارائه آموزش های روانشناسی و تربیتی لازم به اولیا و ایجاد هم سویی بین آموزشگاه و اولیا",
  },
]);
